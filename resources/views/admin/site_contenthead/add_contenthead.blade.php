                            ...
                            <form class="form-horizontal" method='POST' action="{{ url('/admin/add_contenthead') }}" name="add_contenthead" id="add_contenthead" enctype="multipart/form-data" >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">
                                        <div>
                                            <img class="rounded responsive modalImage preview_image_file" id="contenthead_image_preview" src="{{ asset(config('constants.backend_address').'/assets/images/no_preview.jpg') }}" alt="" name="contenthead_image_preview" style="max-width: 100px; max-height: 100px;">
                                        </div>  
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">
                                        <div>
                                            <img class="rounded responsive modalImage preview_logo_image_file" id="contenthead_logo_image_preview" src="{{ asset(config('constants.backend_address').'/assets/images/no_preview.jpg') }}" alt="" name="contenthead_logo_image_preview" style="max-width: 100px; max-height: 100px;">
                                        </div>  
                                        <div style="margin-top:5px">
