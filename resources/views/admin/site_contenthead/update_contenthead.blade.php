                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            @endif 
                            <form class="form-horizontal" method='POST' action="{{ url('/admin/update_contenthead') }}" name="update_contenthead" id="update_contenthead" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="input_contenthead_title" id="input_contenthead_title" placeholder="İçerik başlığı" value="{{ $data->contenthead_title }}">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" name="input_contenthead_slug" id="input_contenthead_slug" placeholder="İçerik slug" value="{{ $data->contenthead_slug }}">
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control" name="input_contenthead_keywords" id="input_contenthead_keywords" placeholder="Anahtar kelimeler" value="{{ $data->contenthead_keywords }}">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <textarea class="form-control" name="input_contenthead_title_description" id="input_contenthead_title_description" placeholder="İş açıklaması" >{{ $data->contenthead_title_description }}</textarea>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <textarea class="form-control" name="input_contenthead_description" id="input_contenthead_description" placeholder="İçerik tam açıklaması" >{{ $data->contenthead_description }}</textarea>
                                      ...
                                      <div class="col-md-9">
                                        ...
                                        <div style="margin-top:5px">
                                            ...
                                            <button type="button" class="transparent_button delete_image_button"
                                                id="input_contenthead_image_delete" name="input_contenthead_image_delete">
                                      ...
                                      <div class="col-md-9">
                                        ...
                                        <div style="margin-top:5px">
                                            ...
                                            <button type="button" class="transparent_button delete_logo_image_button"
                                                id="input_contenthead_logo_image_delete" name="input_contenthead_logo_image_delete">
                                                <i class="fas fa-undo" style="color:orange; padding:5px"></i>
                                            </button>                                       
                                        </div>
                                      </div>
                                    </div>
                                    <input type="hidden" name="contenthead_id" id="contenthead_id" value="{{ $data->id }}">
                                    <input class="input_hidden_image_name" type="hidden" name="input_hidden_contenthead_image_name" id="input_hidden_contenthead_image_name" value="{{ $data->contenthead_image_name }}">
                                    <input class="input_hidden_logo_image_name" type="hidden" name="input_hidden_contenthead_logo_image_name" id="input_hidden_contenthead_logo_image_name" value="{{ $data->contenthead_logo_image_name }}">
