                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">İşler ekle</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            @endif 
                            <form class="form-horizontal" method='POST' action="{{ url('/admin/add_portfolio') }}" name="add_portfolio" id="add_portfolio" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">
                                          <select class="select2 form-control custom-select" name="input_portfolio_marka_id" id="input_portfolio_marka_id" style="width: 100%; height:36px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="input_portfolio_title" id="input_portfolio_title" placeholder="İş başlığı" value="{{ old('input_portfolio_title') }}">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" name="input_portfolio_slug" id="input_portfolio_slug" placeholder="İş slug" value="{{ old('input_portfolio_slug') }}">
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control" name="input_portfolio_keywords" id="input_portfolio_keywords" placeholder="Anahtar kelimeler" value="{{ old('input_portfolio_keywords') }}">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <textarea class="form-control" name="input_portfolio_description" id="input_portfolio_description" placeholder="İş açıklaması"  value="{{ old('input_portfolio_description') }}"></textarea>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">
                                        <div>
                                            <img class="rounded responsive modalImage preview_image_file" id="portfolio_image_preview" src="{{ asset('backend_assets/assets/images/no_preview.jpg') }}" alt="" name="portfolio_image_preview" style="max-width: 100px; max-height: 100px;">
                                        </div>  
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" value="Yeni iş ekle" class="btn btn-primary">
