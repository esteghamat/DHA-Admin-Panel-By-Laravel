              ...
              <div class="ml-auto text-right">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Kategory ekle</li>
                      </ol>
                  </nav>
              </div>
          </div>
      ...
      <div class="row">
          <div class="col-md-10">
              <div class="card">
                  ...
                  @endif 
                  <form class="form-horizontal" method='POST' action="{{ url('/admin/add_category') }}" name="add_kategory" id="add_kategory" enctype="multipart/form-data" >
                      {{ csrf_field() }}
                      <div class="card-body">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <div class="custom-control custom-radio select-category-level">
                                    <input type="radio" class="custom-control-input" id="input_category_level1" name="input_category_level" value="mainCategory" checked="checked" required>
                                    <label class="custom-control-label" for="input_category_level1">Ana Kategori</label>
                                </div>
                                <div class="custom-control custom-radio select-category-level">
                                    <input type="radio" class="custom-control-input" id="input_category_level2" name="input_category_level" value="subCategory" required>
                            ...
                            <div class="col-md-4">
                                <select class="select2 form-control custom-select" id="input_select_category_level" name="input_select_category_level" style="width: 100%; height:36px;" disabled>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" class="form-control" name="input_category_name" id="input_category_name" placeholder="Kategory adı" value="{{ old('input_category_name') }}">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" class="form-control" name="input_category_slug" id="input_category_slug" placeholder="Kategory slug"  value="{{ old('input_category_slug') }}">
                                  <span id="categorySlug_msg"></span>
                                  @error('input_category_slug')
                                    <div class="error_msg">{{ $message }}</div>
                                  @enderror
                              </div>
                          </div>
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" class="form-control" name="input_category_description" id="input_category_description" placeholder="Kategory açıklaması"  value="{{ old('input_category_description') }}">
                                  <span id="categoryDesc_msg"></span>
                              </div>
                          </div>
                      <div class="border-top">
                          <div class="card-body">
                              <input type="submit" value="Yeni kategory ekle" class="btn btn-primary">
